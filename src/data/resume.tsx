...
export const DATA = {
  ...
  summary:
    "Aspiring engineer and undergraduate student (2nd year) with a strong passion for web development and problem-solving. Constantly learning and exploring new technologies to build expertise in software development. Enthusiastic about tackling challenges, optimizing solutions, and creating meaningful digital experiences. Dedicated to continuous growth and improvement in the ever-evolving tech landscape.",
  avatarUrl: "/mee.png",
  skills: [
    "React",
    "Next.js",
  ...
  contact: {
    ...
    social: {
      ...
      email: {
        name: "Send Email",
        url: "mailto:bharathnox@gmail.com",
        icon: Icons.email,
  ...
  education: [
    ...
    },
    {
      ...
      degree: "Intermediate Certificate",
      logoUrl: "/inter.png",
      start: "2021",
      end: "2023",
    },
    {
      school: "St. Arnold's High School",
      href: "https://www.starnolds.org/",
